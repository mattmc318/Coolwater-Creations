...
this.onSettledCallbacks_=null}};var f=new b;d.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};d.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(h){c.reject(h)}};d.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{e(a(b))}catch(m){g(m)}}:b}var e,g,f=new d(function(a,b){e=a;g=b});this.callWhenSettled_(c(a,e),c(b,g));return f};
...
$(function(){var a=$(window),b=$("body"),c=$(".banner"),e=$("#page"),d=e.children(".logo"),f=e.children(".content");switch(getCookie("gdpr")){case "":setCookie("gdpr","false");case "false":c.show();break;case "true":c.hide()}c.on("click",".close",function(a){a.preventDefault();c.hide();setCookie("gdpr","true")});var g=!0,l=a.width(),k=a.height();d.on("click touchstart",function(a){a.preventDefault();f.animate({scrollTop:Math.ceil(k-d.outerHeight())},1E3)});e=function(){var c,e,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){1==
h.nextAddress&&(l=a.width(),k=a.height(),b.css({"--page-height":k+"px"}),c=0,e=function(){c=d.outerHeight();b.css({"--logo-height":c+"px"});if(l>k&&!1===g||l<=k&&!0===g)$("#bg, #page").toggleClass("landscape").toggleClass("portrait"),g=!g},e(),f=0);if(5!=h.nextAddress)return 100>c&&60>f?h.yield(sleep(),5):h.jumpTo(0);e();f++;return h.jumpTo(2)})};a.on("resize orientationchange",e);e()});
