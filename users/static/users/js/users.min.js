...
this.onSettledCallbacks_=null}};var f=new b;d.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};d.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(h){c.reject(h)}};d.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{e(a(b))}catch(q){g(q)}}:b}var e,g,f=new d(function(a,b){e=a;g=b});this.callWhenSettled_(c(a,e),c(b,g));return f};
...
$(function(){var a=$(window),b=$(".banner"),c=$(".bg"),e=$(".logo"),d=$(".content"),f=d.children(".content-container").children("ul");switch(getCookie("gdpr")){case "":setCookie("gdpr","false");case "false":b.show();break;case "true":b.hide()}b.on("click",".close",function(a){a.preventDefault();b.hide();setCookie("gdpr","true")});var g=!0,n=function(){c.toggleClass("landscape").toggleClass("portrait");g=!g},k=a.width(),h=a.height();e.on("click touchstart",function(a){a.preventDefault();d.animate({scrollTop:Math.ceil(h-
e.outerHeight())},1E3)});var p=function(){var b,d,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){1==l.nextAddress&&(k=a.width(),h=a.height(),c.css({"--bg-height":h+"px"}),b=0,d=function(){b=e.outerHeight();c.css({"--logo-height":b+"px"});k>h?(f.css({"flex-direction":"row"}),!1===g&&n()):(f.css({"flex-direction":"column"}),!0===g&&n())},d(),m=0);if(5!=l.nextAddress)return 100>b&&60>m?l.yield(sleep(),5):l.jumpTo(0);d();m++;return l.jumpTo(2)})};a.on("resize orientationchange",p);p()});
